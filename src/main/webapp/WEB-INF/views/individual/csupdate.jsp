...
<%@ include file="/WEB-INF/views/include/headerindi.jsp" %>
     ...
     <div class= "div6">
       <main class ="main">
         <form action="/Individual/Csupdate?csp_id=${vo.csp_id}&user_id=${sessionScope.login.user_id}"  method="POST">
         <table>
      ...
      <script>
         const goMain      = document.getElementById('goMain')
  			goMain.onclick    = function() {
  				location.href = '/Individual/Cslist?csp_id=${vo.csp_id}&user_id=${sessionScope.login.user_id}'
  			}  
