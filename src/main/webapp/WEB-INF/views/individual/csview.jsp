...
<hr style="border: 1px solid #ccc; margin: 20px 0;">
     ...
     <div class="button" > 	
       <a class="btn btn-outline-primary" 
         href="/Individual/CswriteForm?csp_id=${vo.csp_id}&user_id=${sessionScope.login.user_id}">새 글 쓰기</a>
       ...
       <a class="btn btn-outline-danger" 
         href="/Individual/Csdelete?csp_id=${vo.csp_id}&user_id=${sessionScope.login.user_id}">삭제</a>
       </c:if>
       <a class="btn btn-outline-success" 
         href="/Individual/Cslist?csp_id=${vo.csp_id}&user_id=${sessionScope.login.user_id}">목록</a>
      </div>
