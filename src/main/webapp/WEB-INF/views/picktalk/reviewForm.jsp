...
<main>
<h1>리뷰 추가</h1>
<form action="/picktalk/review" method="post">
    ...
    <div class="rating">
        <input type="radio" id="mood_star5" name="mood" value="5" required />
        <label for="mood_star5">★</label>
        <input type="radio" id="mood_star4" name="mood" value="4" />
        <label for="mood_star4">★</label>
        <input type="radio" id="mood_star3" name="mood" value="3" />
        <label for="mood_star3">★</label>
        <input type="radio" id="mood_star2" name="mood" value="2" />
        <label for="mood_star2">★</label>
        <input type="radio" id="mood_star1" name="mood" value="1" />
    ...
    <div class="rating">
        <input type="radio" id="difficulty_star5" name="difficulty" value="5" required />
        <label for="difficulty_star5">★</label>
        <input type="radio" id="difficulty_star4" name="difficulty" value="4" />
        <label for="difficulty_star4">★</label>
        <input type="radio" id="difficulty_star3" name="difficulty" value="3" />
        <label for="difficulty_star3">★</label>
        <input type="radio" id="difficulty_star2" name="difficulty" value="2" />
        <label for="difficulty_star2">★</label>
        <input type="radio" id="difficulty_star1" name="difficulty" value="1" />
