...
<body>
    ...
    <div class="container">
        <h2>기업 로그인</h2>
        <input type="button" onclick="location.href='/Individual/Login'" value="개인 로그인" style="width: 190px; background-color: #405DAB;"/>
        <input type="button" onclick="location.href='/Company/Login'" value="기업 로그인" style="width: 300px;" />
